...
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="utils/style.css"/>
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="utils/bootstrap.min.css"/>
...
#+HTML_HEAD: <script src="utils/app.js"></script>
